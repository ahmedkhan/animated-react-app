        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 text-center text-md-left ">
                    ...
                    <div class="py-0">
                        <h3 class="my-4 text-white">About<span class="mx-2 font-italic text-warning ">Stick'Me</span></h3>
                        ...
                        <p class="text-light py-4 mb-4">&copy;2019 stick'Me Learning Solutions Pvt. Ltd.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 text-white my-4 text-center text-md-left ">
					...
					<p class="text-warning my-2" >We offer artical writing services across Technology, Design, Management, Science and Humanities.</p>
                    <div class="py-2">
